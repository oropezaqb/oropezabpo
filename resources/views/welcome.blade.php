    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Tax Filing and Consultancy Services</h2>
              <p>These services include filing tax returns with corresponding attachments, tax payment, tax audit and consultancy services. These services are designed to minimize exposure to tax risks, which are part of business compliance risks.</p>
              <div class="text-center"><a href="https://calendly.com/oropezabpo/30min" class="btn-get-started">Book Now</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              <h2>Accounting and Finance Services</h2>
              <p>These services include bookkeeping, preparation of financial statements and management reports including financial analyses, finance business partnering, financial modeling, internal audit and treasury services.</p>
              <div class="text-center"><a href="https://calendly.com/oropezabpo/30min" class="btn-get-started">Book Now</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right">
            <h2>Business Process Outsourcing Services</h2>
            <h3>Is growing your business becoming too much to handle? Get professional help from the experts! #OropezaBPO is the perfect BPO solution for you.</h3>
          </div>
